...
import AnalysisTab from './DashboardComponets/Analysis-replacement/Analysis';
import ControlsTab from './DashboardComponets/ControlsTab';
import HomeTab from './DashboardComponets/Home/HomeTab';
...
const Dashboard = () => {
  ...
  const renderActiveComponent = () => {
    ...
    if (activeTab === 0) {
      return (
        <HomeTab
          ...
          stats={stats}
          onRefreshAppliances={fetchAppliances}
          onRefreshLoadshedding={fetchLoadsheddingData}
    ...
    // Analytics tab - FIXED: Added onNavigateToAnalytics prop
    if (activeTab === 2) {
      return (
        <AnalysisTab
          appliances={appliances}
