// AnalysisTab.js - OPTIMIZED with SmartSimulator fix
...
try {
  ...
  // Fallback component if SmartSimulator doesn't exist
...
export default function AnalysisTab({ appliances: propAppliances = [], stats = {} }) {
  ...
  // Render statistics cards - 3x2 GRID
    ...
    if (activeDevices.length === 0) {
      return (
        <View style={styles.noDataContainer}>
          <MaterialIcons name="bar-chart" size={48} color="#a1a1aa" />
  ...
  // Render pie chart with room distribution
  const renderPieChart = () => {
    ...
    if (activeRooms.length === 0) {
      return (
        <View style={styles.noDataContainer}>
          <MaterialIcons name="pie-chart" size={48} color="#a1a1aa" />
          <Text style={styles.noDataText}>No active devices</Text>
    ...
    return (
      <View style={styles.pieChartContainer}>
        ...
        {/* Central power indicator - clickable */}
        <TouchableOpacity
          onPress={() => {
          ...
          activeOpacity={0.8}
          style={[styles.center, { marginVertical: 12 }]}
        >
          <View style={styles.pieCenter}>
            <Text style={styles.pieCenterValue}>{totalPower}W</Text>
            <Text style={styles.pieCenterLabel}>Tap for details</Text>
          </View>
        </TouchableOpacity>
        ...
        <Text style={styles.pieHint}>Tap center or any room for detailed breakdown</Text>
      </View>
    );
  };
        ...
        <View style={styles.roomModalItem}>
          ...
          <View style={styles.roomModalStats}>
            <View style={styles.roomModalStat}>
              <MaterialIcons name="power" size={14} color="#10b981" />
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
            ...
            appliances
              ...
              .map(device => (
                <View key={device.id} style={styles.deviceItem}>
                  ...
                  <View style={styles.devicePowerContainer}>
                    <Text style={[
                      styles.devicePower,
                      device.status === 'on' && { color: '#10b981' }
                    ]}>
                      {device.status === 'on' ? `${device.normal_usage || 0}W` : 'OFF'}
                    </Text>
                  </View>
        ...
        {/* SmartSimulator Button */}
        <TouchableOpacity style={styles.mlButton} onPress={openSmartSimulator}>
          <MaterialIcons name="auto-awesome" size={20} color="#ffffff" />
          <Text style={styles.mlButtonText}>Open Smart Simulator</Text>
        </TouchableOpacity>
      ...
      {/* SmartSimulator Modal - FIXED WITH SAFEAREAVIEW */}
      <Modal
        visible={showSmartSimulator}
        animationType="slide"
        presentationStyle="fullScreen"
        onRequestClose={closeSmartSimulator}
        transparent={false}
      >
        <SafeAreaView style={{ flex: 1, backgroundColor: '#0a0a0b' }}>
